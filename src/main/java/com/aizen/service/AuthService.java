...
public class AuthService {
    ...
    public User register(String username, String password, String fullName, String email)
        ...
        String u = ValidationUtil.requireUsername(username);
        String name = ValidationUtil.requireNonBlank("Full name", fullName);
        String mail = ValidationUtil.requireEmail("E-mail", email);
        ...
        user.setEmail(mail);
        user.setSalt(PasswordUtil.newSalt());
